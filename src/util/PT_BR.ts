  ...
  about = {
    ...
    text: [
      `Me chamo Franklin Regis, tenho 23 anos e sou graduado em Ciência da Computação na Universidade Federal 
                de Campina Grande, atualmente buscando o título de Mestre em Engenharia de Software.`,
    ...
    informations: [
      {
        ...
        value: 2,
        content:
          "ano de experiência atuando puramente como Desenvolvedor Frontend",
      },
      {
        type: "Trabalho",
        value: 1,
        content: "ano de experiência atuando como Desenvolvedor FullStack",
      },
      {
        type: "Competições",
        value: 1,
        content: "participação em Olímpiada Internacional",
      },
      {
        type: "Inovação",
        value: 1,
        content:
          "ano de experiência com projetos de Extensão e Inovação Tecnológica",
      },
      {
        type: "Inglês",
        value: "B2",
        content: "nível QCE de inglês (Avançado)",
      },
      {
        type: "Produção",
        value: 2,
        content: "artigos publicados em congresso nacional",
      },
    ],
  };
    ...
    web: [
      {
        ...
        title: "MyPortfolium",
        description:
          "Código-fonte deste portfólio, usando Static Site Generation (SSG).",
      ...
      },
      {
        ...
        title: "SimLa",
        description:
          "(Freelance) Customizador de ladrilhos virtual para manufatura de cerâmicas",
        labels: [LABELS.NEXT, LABELS.REACT],
      ...
      },
      {
        ...
        title: "Lost Hollow",
        description:
          "(Freelance) Site complementar para estudar e visualizar o Tarot de Lost Hollow",
    ...
    mobile: [
      {
        ...
        title: "Beez",
        description:
          "Aplicação Mobile para encontrar formas de entretenimento próximas de você.",
      ...
      },
      {
        ...
        title: "PlantManager",
        description:
          "Aplicação Mobile para cadastrar e gerenciar suas plantas de casa.",
    ...
    miscellaneous: [
      {
        ...
        title: "SIGES",
        description:
          "Sistema de gerenciamento e ocupação de salas, laboratórios e ambientes coletivos.",
      ...
      },
      {
        ...
        title: "Gummy",
        description:
          "Bot para o Discord com funcionalidades lúdicas/do dia-a-dia.",
      ...
      },
      {
        ...
        title: "LittleGames",
        description:
          "Games autorais (código e assets) feitos para aprender programação de jogos.",
      ...
      },
      {
        ...
        title: "DS-Begins",
        description:
          "Modelos introdutórios de Ciência de Dados, Machine Learning e Deep Learning.",
